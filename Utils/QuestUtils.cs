...
namespace DynamicMaps.Utils
{
    ...
    public static class QuestUtils
    {
        ...
        private static PropertyInfo _questControllerQuestsProperty = AccessTools.Property(typeof(EFT.Quests.QuestController), "Quests");
        // 4.1.3：Quests = QuestBook : ConditionalBook<Quest> : BindableList<Quest>——quests 列表在基类 BindableList 的 List 字段
        private static FieldInfo _questsListField = AccessTools.Field(_questControllerQuestsProperty.PropertyType, "List");
